...
try:
    ...
    print('Warning: wandb package cannot be found. The option "--use_wandb" will result in error.', flush=True)
...
class Visualizer():
    ...
    def __init__(self, opt):
        ...
        if self.use_html:  # create an HTML object at <checkpoints_dir>/web/; images will be saved under <checkpoints_dir>/web/images/
            ...
            print('create web directory %s...' % self.web_dir, flush=True)
    ...
    def create_visdom_connections(self):
        ...
        print('\n\nCould not connect to Visdom server. \n Trying to start a server....', flush=True)
